...
export function NotificationsPopover({ notifications: initialNotifications }: NotificationsPopoverProps) {
  ...
  return (
    <div className="relative">
      ...
      >
        ...
        {unreadCount > 0 && (
          <span className="absolute -top-1 -right-1 flex h-4 min-w-[16px] items-center justify-center rounded-full bg-indigo-600 px-1 text-[10px] font-bold text-white ring-2 ring-[#0a0c10] animate-pulse">
